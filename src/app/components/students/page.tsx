  ...
  return (
    <div className="flex flex-col w-full h-full bg-neutral-100 p-8">
              ...
              <table className="flex flex-col w-full justify-center mx-auto">
                <th className="flex justify-between items-center p-5 border-t-[1px] border-neutral-200">
                  
                  <div></div>
                  <p className="flex text-xs text-neutral-400 font-semibold">
                    Name
                  </p>
                  <p className="flex text-xs text-neutral-400 font-semibold">
                    Email
                ...
                <td className="flex justify-between items-center w-full bg-white rounded-lg p-3">
                  <Image
                    ...
                    priority
                  />
                  <p className="flex text-black font-normal text-sm">Karthi</p>
                  <p className="flex text-black font-normal text-sm">
                    karthi@gmail.com
                  </p>
                  <p className="flex text-black font-normal text-sm">7305477760</p>
                  <p className="flex text-black font-normal text-sm">
                    1234567305477760
                  </p>
                  <p className="flex text-black font-normal text-sm">
                  ...
                  <div className="flex justify-between gap-9 p-5">
                    <div>
                      <svg
                        width="19"
                        height="19"
