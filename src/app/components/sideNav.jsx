        ...
        <div className="flex flex-col justify-between w-full">
          <div className="flex flex-col gap-3 justify-center items-center p-5">
            <Link
              href="/"
              onClick={handleClick}
              className={`flex w-full justify-center items-center py-2.5 gap-3 cursor-pointer rounded-lg ${
                pathname === "/" ? "bg-amber-400" : "hover:bg-amber-400"
              }`}
            >
            ...
            <Link
              href="/students"
              className={`flex w-full justify-center items-center py-2.5 gap-3 cursor-pointer rounded-lg ${
                pathname === "/students" ? "bg-amber-400" : "hover:bg-amber-400"
              }`}
            >
              <div className="flex w-full justify-center items-center gap-3">
                <svg
            ...
            <Link
              href="/payments"
              className={`flex w-full justify-center items-center py-2.5 gap-3 cursor-pointer rounded-lg ${
                pathname === "/payments" ? "bg-amber-400" : "hover:bg-amber-400"
              }`}
            >
              <div className="flex w-full justify-center items-center gap-3">
                <svg
